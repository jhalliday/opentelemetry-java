...
import io.opentelemetry.proto.profiles.v1.internal.ResourceProfiles;
...
final class ResourceProfilesMarshaler extends MarshalerWithSize {
  ...
  static ResourceProfilesMarshaler[] create(Collection<ProfileContainerData> profiles) {
    Map<Resource, Map<InstrumentationScopeInfo, List<ProfileContainerMarshaler>>> resourceAndScopeMap =
