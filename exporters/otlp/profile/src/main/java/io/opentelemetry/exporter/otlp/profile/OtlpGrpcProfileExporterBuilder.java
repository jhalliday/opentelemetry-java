...
/** Builder for {@link OtlpGrpcProfileExporter}. */
public final class OtlpGrpcProfileExporterBuilder {
  ...
  // Visible for testing
  final GrpcExporterBuilder<ProfileRequestMarshaler> delegate;

  OtlpGrpcProfileExporterBuilder() {
    delegate =
        GrpcExporter.builder(
            ...
            DEFAULT_ENDPOINT,
            () -> MarshalerProfileServiceGrpc::newFutureStub,
            GRPC_ENDPOINT_PATH);
   ...
   */
  @Deprecated
  public OtlpGrpcProfileExporterBuilder setChannel(ManagedChannel channel) {
   ...
   */
  public OtlpGrpcProfileExporterBuilder setTimeout(long timeout, TimeUnit unit) {
   ...
   * unset, defaults to {@value DEFAULT_TIMEOUT_SECS}s.
   */
  public OtlpGrpcProfileExporterBuilder setTimeout(Duration timeout) {
   ...
   */
  public OtlpGrpcProfileExporterBuilder setEndpoint(String endpoint) {
   ...
   */
  public OtlpGrpcProfileExporterBuilder setCompression(String compressionMethod) {
   ...
   */
  public OtlpGrpcProfileExporterBuilder setTrustedCertificates(byte[] trustedCertificatesPem) {
   ...
   */
  public OtlpGrpcProfileExporterBuilder setClientTls(byte[] privateKeyPem, byte[] certificatePem) {
   ...
   */
  public OtlpGrpcProfileExporterBuilder setSslContext(
   ...
   * OtlpGrpcProfileExporterBuilder#setChannel(ManagedChannel)} is not used to set channel.
   *
   * @param key header key
   * @param value header value
   * @return this builder's instance
   */
  public OtlpGrpcProfileExporterBuilder addHeader(String key, String value) {
   ...
   */
  public OtlpGrpcProfileExporterBuilder setMeterProvider(MeterProvider meterProvider) {
  ...
  public OtlpGrpcProfileExporter build() {
    return new OtlpGrpcProfileExporter(delegate.build());
  }
}
