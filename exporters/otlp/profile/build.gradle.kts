...
description = "OpenTelemetry Protocol (OTLP) Profile Exporters"
otelJava.moduleName.set("io.opentelemetry.exporter.otlp.profile")
  ...
  suites {
    val testGrpcNetty by registering(JvmTestSuite::class) {
      dependencies {
        ...
        implementation(project(":sdk:profile-testing"))
